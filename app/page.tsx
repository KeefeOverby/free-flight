    ...
    return (
        <main className="grid grid-cols-1 h-screen w-full p-4">
            <section className="flex flex-col h-full w-full items-center justify-between">
                ...
                >
                    <p className="h-fit w-full text-xl text-center">
                        Landing Page
                    </p>
                                                    ...
                                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                        ...
                                                        <div className="mt-2">
                                                            <p className="text-sm text-gray-500">
                                                                We thank you for taking the time to visit our application.
                                                                Please consider leaving us with your feedback and email.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
